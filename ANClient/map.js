...
function createMapText() {
    ...
    div.innerHTML = "<table cellpadding=0 cellspacing=0 border=0 width=" + ancmapwidth + "><tr><td align=center id=\"maptext\" style=\"font-family:Verdana; font-size:12px; color:#999999; font-weight:bold; text-shadow:2px 2px 5px black;\"></td></tr></table>";
