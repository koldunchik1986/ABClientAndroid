...
var ancmapwidth = (((width * 2) + 1) * scale) + (width * 2) + 2;
var ancmapheight = (((height * 2) + 1) * scale) + (height * 2) + 2;
// -ANC
...
function view_map()
{
    ...
    d.write('<table cellpadding=1 cellspacing=0 border=0 width=100%><tr><td bgcolor=#FFFFFF align=center><div style="position: absolute; text-align: center; overflow: hidden; width: ' + ancmapwidth + 'px; height: ' + ancmapheight + 'px;" id="world_cont"></div><div style="width: ' + ancmapwidth + 'px; height: ' + ancmapheight + 'px; text-align: left;" id="world_cont2"></div></td></tr></table>');
    createMapText();
...
function createMapText() {
    ...
    div.innerHTML = '<table cellpadding=0 cellspacing=0 border=0 width=' + ancmapwidth + '><tr><td align=center id="maptext" style="font-family: Verdana; font-size: 12px; color: #999999; font-weight: bold; filter:glow(color=black, strength=5);"></td></tr></table>';
