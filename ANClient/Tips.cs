namespace ANClient
{
    internal static class Tips
    {
        ...
        {
            "Связаться с автором <b>ANClient</b> очень просто - Skype: <b>wmlab.home</b>, сайт: <b><a href='https://github.com/wmlabtx/anclient/wiki/' onclick='window.open(this.href);'>https://github.com/wmlabtx/anclient/wiki/</a></b>, E-mail: <b>wmlab@hotmail.com</b>", 
            "<b>ANClient</b> может попытаться вычислить клетки, где находится перс и его соклановцы. Надо открыть инфу перса и нажать на тулбаре кнопку [Компас]",               
            ...
            "<b>ANClient</b> может добавить в контакты сразу весь клан. Открываем инфу любого перса в клане и нажимаем на тулбаре кнопку [Весь клан].", 
            /*"<b>ANClient</b> может сдать пачку вещей в лавку одной кнопкой. Кнопка находится на панели вещи в инвентаре.", */
            "<b>ANClient</b> сам будет разделывать ботов, если надет нож и разделка возможна.", 
            "Серые цифры около маны - это число уникальных пользователей, запустивших ANClient 2.18 и более поздней версии за последние сутки. Число считается в момент Вашего захода в игру или перезахода в игру и не обновляется в процессе игры.",  
