    ...
    internal static partial class Filter
    {
        private static byte[] PinfoJs(byte[] array)
        {
            ...
            var strNewObrazHead =
                ...
                "var obrazsuffix; " +
                "if (newimage.indexOf('anclient.1gb.ru') == -1) " +
                "obrazsuffix = '</td>'; " +
                @"else " +
                @"obrazsuffix = '<br><table cellpadding=0 cellspacing=1 border=0><tr><td bgcolor=white><table cellpadding=0 cellspacing=1 border=0><tr><td bgcolor=#BFBFBF width=255 align=center title=""Установка индивидуального образа - $10. Свяжитесь с автором ANClient (ICQ: 92138051)."" style=""cursor:hand; font-family:Verdana; font-size:9px; font-weight:bold; color:white"">ANClient</td></tr></table></td></tr></table></td>'; " +
