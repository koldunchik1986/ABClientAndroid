...
namespace ANClient
{
    internal static class AppVars
    {
        ...
        /// </summary>
        internal static readonly VersionClass AppVersion = new VersionClass("ANClient", Application.ProductVersion);
        ...
        /// <summary>
        /// Число юзеров ANC, зашедших за последние сутки.
        /// </summary>
        ...
        internal const string UserKeyAnclientServerError = "!ANCLIENT";
