namespace ANClient
{
    ...
    {
        internal static readonly string ApplicationName = "ANClient";
        ...
        internal static readonly string KeyFile = "anclient2.key";
        internal static readonly string KeyFileTemp = "anclient2.key$";

        #endregion

        #region Папки

        internal static readonly string CacheDir = "ancache";
        internal static readonly string TestDir = "antest";
        internal static readonly string SamplesDir = "ansamples";
        ...
        public const string TagAncMapCell = "cell";
        public const string AttrAncMapRegNum = "regnum";
        public const string AttrAncMapCost = "cost";
        public const string AttrAncMapLabel = "label";
        public const string AttrAncMapVisited = "visited";
        public const string AttrAncMapVerified = "verified";
        ...
        //internal const string AbcObrazyUrl = "http://anclient.1gb.ru/abcobrazy/";
        ...
        internal const string FileMap = "ancells.xml";
