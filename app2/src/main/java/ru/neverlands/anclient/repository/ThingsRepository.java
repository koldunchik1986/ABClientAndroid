...
/*
import ru.neverlands.anclient.db.AppDatabase;
import ru.neverlands.anclient.db.ThingDao;
*/
import ru.neverlands.anclient.model.Thing;
    ...
    public void initialize(Context context) {
        executor.execute(() -> {
            ...
            if (count == 0) {
                ...
                try {
                    InputStream inputStream = context.getAssets().open("anthings.xml");
