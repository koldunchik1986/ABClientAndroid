...
final class CompasAuto {
    ...
    private List<CellEntry> collectCellEntries() {
        ...
        for (java.util.Map.Entry<String, ru.neverlands.anclient.model.Cell> mapEntry : ExtMap.Cells.entrySet()) {
    ...
    private String formatCompassCellsLinks(List<String> regNums) {
        ...
        for (String regNum : regNums) {
            ...
            if (value.matches("\\d{1,4}-\\d{1,5}")) {
                builder.append("<a style='text-decoration:none' href='anmove://")
                        .append(safeValue)
                        .append("'><b>")
                        .append(safeValue)
                        .append("</b></a>");
