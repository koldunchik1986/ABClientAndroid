...
public class FastActionManager {
        ...
        if (!flog.isEmpty()) {
            ...
            try {
                while (!AppVars.FastWaitEndOfBoiCancel) {
                    ...
                    String off = ru.neverlands.anclient.utils.HelperStrings.subString(html, "var off = ", ";");
                ...
                if (chunk.contains("magicreform(")) {
                    ...
                    if (args != null && !args.isEmpty()) {
                        ...
                        if (arg.length >= 7) {
                            ...
                            ru.neverlands.anclient.utils.FileLogger.trace("fast_action_potion", msg);
                        }
                    }
                }
            }
    ...
    private static String mainPhpFastPotion(String html) {
        ...
        if (result == null || result.length < 2) {
            ...
            ru.neverlands.anclient.utils.FileLogger.trace("fast_action_potion", notFoundMsg);
            return null;
        }
        ...
        ru.neverlands.anclient.utils.FileLogger.trace("fast_action_potion", foundMsg);
    ...
    */
    ...
    private static String buildSubmitScript() {
        return "<script language=\"JavaScript\">" +
                "console.log('ANClient: submitting form ff, action=' + document.ff.action);" +
                "document.ff.submit();" +
                "</script></body></html>";
    }
