package ru.neverlands.anclient.service;
...
import ru.neverlands.anclient.postfilter.FishAjaxPhp;
import ru.neverlands.anclient.utils.AppVars;
import ru.neverlands.anclient.utils.Chat;
import ru.neverlands.anclient.utils.ForcedActionGuard;
...
public class AutoModeForegroundService extends Service {
            ...
            try {
                ...
                if (!uiForegroundLikely && !captchaDialogVisible && hasPendingBackgroundPipelineTasks()) {
                    ...
                    if (sinceLastPipelineTick >= POST_FIGHT_PIPELINE_MIN_INTERVAL_MS) {
                        if (activity.getMainWebView() != null) {
                            String pipelineUrl = "http://neverlands.ru/main.php?r=" + tickNow + "&an_bg_pipeline=1";
    ...
    private void maybeForceFightFrameSync(MainActivity activity, long tickNow, String pendingFightFinishLink) {
        ...
        String syncUrl = "http://neverlands.ru/main.php?r=" + tickNow + "&an_force_fight_sync=1";
        ...
        if (wakeLock == null) {
            ...
            if (powerManager != null) {
                wakeLock = powerManager.newWakeLock(
                        ...
                        "ru.neverlands.anclient:AutoModeWakeLock");
            ...
            try {
                ...
                if (wifiManager != null) {
                    ...
                    wifiLock = wifiManager.createWifiLock(
                            wifiLockMode,
                            "ru.neverlands.anclient:AutoModeWifiLock");
    ...
    private Notification buildNotification(String contentText) {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentTitle("ANClient: фоновый авто-режим")
