...
/**
 * Порт postfilter для /js/hp.js из ПК-версии (ANClient/PostFilter/HpJs.cs).
 *
...
public class HpJs {
    ...
    private static final String BRIDGE_EXPRESSION =
            "(function(){var __an=(window.AndroidBridge&&typeof window.AndroidBridge.ShowHpMaTimers==='function')?window.AndroidBridge:(window.external&&typeof window.external.ShowHpMaTimers==='function'?window.external:null);return __an?__an.ShowHpMaTimers(s,curHP,maxHP,intHP,curMA,maxMA,intMA):(s.substring(0, s.lastIndexOf(':')+1) + \"[<font color=#bb0000><b>\" + Math.round(curHP)+\"</b>/<b>\"+maxHP+\"</b></font> | <font color=#336699><b>\"+Math.round(curMA)+\"</b>/<b>\"+maxMA+\"</b></font>]\");})()";
