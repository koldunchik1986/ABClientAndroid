...
public class WebViewRequestInterceptor {
    ...
    public static WebResourceResponse intercept(WebResourceRequest request) {
        ...
        try {
            ...
            if (urlString.contains("/modules/code/code.php")
                    && ru.neverlands.anclient.utils.AppVars.IsFightCaptchaDialogVisible) {
                String expectedCaptchaUrl = normalizeCaptchaUrl(ru.neverlands.anclient.utils.AppVars.CodeAddress);
                ...
                if (!expectedCaptchaUrl.isEmpty()
                    ...
                    byte[] expectedCaptchaBytes = ru.neverlands.anclient.utils.AppVars.LastFightCaptchaImageBytes;
                    String cachedCaptchaUrl = ru.neverlands.anclient.utils.AppVars.LastFightCaptchaImageUrl;
                ...
                byte[] cachedCaptchaBytes = ru.neverlands.anclient.utils.AppVars.LastFightCaptchaImageBytes;
                String cachedCaptchaUrl = ru.neverlands.anclient.utils.AppVars.LastFightCaptchaImageUrl;
                long cachedCaptchaAtMs = ru.neverlands.anclient.utils.AppVars.LastFightCaptchaImageAtMs;
            ...
            if (ru.neverlands.anclient.utils.AppVars.Profile != null
                    && ru.neverlands.anclient.utils.AppVars.Profile.LezDoAutoboi
                    && ru.neverlands.anclient.utils.AppVars.Autoboi == ru.neverlands.anclient.model.AutoboiState.AutoboiOn
            ...
            if (urlString.contains("/modules/code/code.php")) {
                ru.neverlands.anclient.utils.AppVars.LastFightCaptchaImageBytes = bytes;
                ru.neverlands.anclient.utils.AppVars.LastFightCaptchaImageUrl = urlString;
                ru.neverlands.anclient.utils.AppVars.LastFightCaptchaImageAtMs = System.currentTimeMillis();
            ...
            byte[] processed = Filter.process(ru.neverlands.anclient.utils.AppVars.getContext(), urlString, bytes);
            if (processed == null) {
            ...
            try {
                ...
                ru.neverlands.anclient.utils.SessionManager.getInstance()
            ...
            processed = ru.neverlands.anclient.utils.HtmlUtils.injectJsFix(processed, urlString, contentType);
    ...
    private static String buildAutoboiFightJsShim() {
        return "(function(){"
                ...
                + "}catch(e){console.log('ANCLIENT_AUTOSUBMIT_SHIM_ERR:'+e);}"
                + "return false;"
                + "};}"
                + "})();";
    }
    ...
    private static boolean shouldApplyServerTime(long serverMs, long maxDeltaMs, String source) {
        ...
        if (ru.neverlands.anclient.utils.AppVars.Profile == null) return true;
        if (ru.neverlands.anclient.utils.AppVars.Profile.ServDiff == Long.MIN_VALUE) return true;
        long currentServerMs = System.currentTimeMillis() - ru.neverlands.anclient.utils.AppVars.Profile.ServDiff;
        ...
        if (delta > maxDeltaMs) {
            ...
            if ("chat".equalsIgnoreCase(source)
                    && ru.neverlands.anclient.utils.AppVars.ServerDateTime != null) {
    ...
    private static void applyServerTime(long serverMs, String source) {
        ...
        if (ru.neverlands.anclient.utils.AppVars.Profile != null) {
            ru.neverlands.anclient.utils.AppVars.Profile.ServDiff = diffMs;
        }
        ru.neverlands.anclient.utils.AppVars.ServerDateTime = new Date(serverMs);
