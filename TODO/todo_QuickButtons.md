...
- [x] Реальное переключение всех 14 авто-функций (включая AUTO_BAIT, AUTO_DRINK, AUTO_MOVING, AUTO_CUT, AUTO_REFRESH)
- [ ] Реальная HTTP-логика авто-функций (пока только переключение состояния в SharedPreferences)
