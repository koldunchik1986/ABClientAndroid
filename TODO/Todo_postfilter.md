...
**🔗 Детальное сравнение C# ↔ Java**: `TODO/todo_PostFilter_detailed_comparison.md`
...
| FishAjaxPhp.cs          | Фильтр для `fish_ajax.php`                            | `[x]`  | `[+]`      | Полностью портирован (парсинг улова, капча, авто-цикл, проверка удочек) |
